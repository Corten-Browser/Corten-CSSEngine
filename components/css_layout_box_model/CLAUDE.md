# css_layout_box_model Component
...
**Type**: feature (8000 lines estimated)
**Tech Stack**: Rust 2021
**Project**: Corten CSS Engine v0.1.0

You are building ONLY the `css_layout_box_model` component.
...
### Boundaries
- ✅ Work ONLY in `components/css_layout_box_model/`
...
### Commit Pattern
```bash
git commit -m "[css_layout_box_model] test: add color parsing tests"
git commit -m "[css_layout_box_model] feat: implement color parsing (makes tests pass)"
git commit -m "[css_layout_box_model] refactor: extract hex validation logic"
```
...
git add components/css_layout_box_model/

# Commit with prefix
git commit -m "[css_layout_box_model] feat: implement selector matching"

# Or use retry wrapper
python ../../orchestration/git_retry.py "css_layout_box_model" "feat: implement selector matching"
```
...
Your component implements section(s) related to Box model properties.
