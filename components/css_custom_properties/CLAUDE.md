# css_custom_properties Component
...
**Type**: feature (7000 lines estimated)
**Tech Stack**: Rust 2021
**Project**: Corten CSS Engine v0.1.0

You are building ONLY the `css_custom_properties` component.
...
### Boundaries
- ✅ Work ONLY in `components/css_custom_properties/`
...
### Commit Pattern
```bash
git commit -m "[css_custom_properties] test: add color parsing tests"
git commit -m "[css_custom_properties] feat: implement color parsing (makes tests pass)"
git commit -m "[css_custom_properties] refactor: extract hex validation logic"
```
...
git add components/css_custom_properties/

# Commit with prefix
git commit -m "[css_custom_properties] feat: implement selector matching"

# Or use retry wrapper
python ../../orchestration/git_retry.py "css_custom_properties" "feat: implement selector matching"
```
...
Your component implements section(s) related to CSS custom properties (variables).
