...
**Type**: core (8000 lines estimated)
**Tech Stack**: Rust 2021, cssparser
**Project**: Corten CSS Engine v0.1.0

You are building ONLY the `css_parser_values` component.
...
### Purpose
CSS value and property parsing

### Dependencies
- `css_types` (from components/css_types/)

### Boundaries
- ✅ Work ONLY in `components/css_parser_values/`
...
### Commit Pattern
```bash
git commit -m "[css_parser_values] test: add color parsing tests"
git commit -m "[css_parser_values] feat: implement color parsing (makes tests pass)"
git commit -m "[css_parser_values] refactor: extract hex validation logic"
```
...
git add components/css_parser_values/

# Commit with prefix
git commit -m "[css_parser_values] feat: implement selector matching"

# Or use retry wrapper
python ../../orchestration/git_retry.py "css_parser_values" "feat: implement selector matching"
```
...
Your component implements section(s) related to CSS value and property parsing.
