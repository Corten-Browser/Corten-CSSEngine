//! Integration tests for invalidation types

use css_invalidation::{
    ElementId, Invalidation, InvalidationEngine, InvalidationScope, InvalidationSet,
    InvalidationTracker, InvalidationType,
};
...
fn test_invalidation_set_add_invalidation() {
    ...
    let invalidation = Invalidation::new(InvalidationType::State, InvalidationScope::Global, 1000);
