//! Unit tests for InvalidationEngine trait and helper functions

use css_invalidation::{
    InvalidationType, InvalidationScope, Invalidation, InvalidationSet,
    InvalidationTracker, InvalidationEngine, ElementId, DomTree,
    compute_affected_elements, should_invalidate_subtree,
};
